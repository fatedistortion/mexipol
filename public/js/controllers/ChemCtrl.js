...
ChemCtrl.controller('chemController',['$scope', '$http', '$analytics', '$location', '$route', '$routeParams', '$rootScope', function ($scope, $http, $analytics, $location, $route, $routeParams, $rootScope) {
        ...
        var initialize = function ($routeParams) {
            if (typeof $routeParams.category == 'undefined') {
                ...
                $rootScope.description = 'Catálogo de Productos Químicos entre ellos Poliurea, Poliuretano y Recubrimientos para aplicaciones industriales, comerciales y domésticas';
            } else {
        ...
        this.quimicos = [
            ...
            },
            {
                ...
                caption: 'De menor densidad inclusive que ECOFOAM 40, Un sistema de espuma de poliuretano que utiliza agua como agente de expansi\xF3n. Ecol\xF3gico y sin HFCs, Diseñada espec\xEDficamente para el aislamiento t\xE9rmico en construcci\xF3n e industria, es una elecci\xF3n ideal cuando no existen requisitos de resistencia a compresi\xF3n en techos, instalaciones ganaderas, etc.',
                parameters: [
